      ...
      .then((res) => {
        ...
        dispatch({
          ...
          payload: {
            ...
            prefix_code: res.data.prefix_code,
            prefix_name: res.data.prefix_name,
            user_fullname_th: res.data.user_fullname_th,
            user_fullname_eng: res.data.user_fullname_eng,
            faculty: res.data.faculty,
            major: res.data.major,
            year: res.data.year,
            model_name: res.data.model_name,
            class_year_student: res.data.class_year_student,
            student_status: res.data.student_status,
            phone_number: res.data.phone_number,
            phone_number_home: res.data.phone_number_home,
            last_address: res.data.last_address,
            last_level_student: res.data.last_level_student,
            old_school: res.data.old_school,
            last_major: res.data.last_major,
            year_end_old_school: res.data.year_end_old_school,
            gpx_hight_school: res.data.gpx_hight_school,
            student_status: res.data.student_status,
            user_status: res.data.user_status,
            user_image: res.data.user_image,
            email_education: res.data.student_email_education,
          },
        });
      })
      .catch((err) => {
