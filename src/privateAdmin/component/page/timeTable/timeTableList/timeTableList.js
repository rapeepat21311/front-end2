...
import { mockDataTimeTable } from "./mockdata/mockdataTimeTable";
    ...
    <>
      <div
        className={`list_user_page ${
          viewTimeTable && "list_user_page_inactive"
        }`}
      >
          ...
          <div className="list_user_text_option">
            ...
            <div className="add_document_container">
              <div
                ...
                onClick={() => navigate("/admin-page/add-timetable")}
              >
                <img src={plus} />
      ...
      >
        <div
          className={viewTimeTable ? "view_user_active" : "view_user_inactive"}
        >
          {viewTimeTable ? (
            <View_TimeTable
              id={timetableId}
              onClose={() => setViewtimeTable(false)}
            />
          ) : null}
        </div>
      </div>
