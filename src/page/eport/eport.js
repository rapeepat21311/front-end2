...
import Print from "../../svgimage/print";
import Save from "../../svgimage/save";

function Eport() {
  const navigate = useNavigate();
  const [html, setHtml] = React.useState("CurriculumVitae");
    ...
    <div>
      ...
      <div className="eport">
        <div className="eport_body">
          ...
          <div className="cv_header_button">
            <div className="cv_header_button_1">
              <Button>
                <p>
                  <Save/>
                </p>
            ...
            <div className="cv_header_button_2">
          ...
          {/* <div className="cv_container_op_cv"> */}
